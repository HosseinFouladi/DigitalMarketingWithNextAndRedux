  ...
  switch (action.type) {
    ...
    case PRODUCT_TYPES.GET_RELATED_PRODUCTS_FOR_CATEGORY:
      return {
        ...state,
        relatedProducts: [
          ...getRelatedProducts(state.products, action.payload),
        ],
      };
        ...
        currentProduct: {
          ...
          likes:
            action.payload == "increment"
              ? state.currentProduct.likes + 1
              : state.currentProduct.likes - 1,
          isLiked: !state.currentProduct.isLiked,
        },
      };
    case PRODUCT_TYPES.DECREASE_PRODUCT_COUNT:
      return {
        ...
        currentProduct: {
          ...state.currentProduct,
          count: state.currentProduct.count - 1,
        },
      };
