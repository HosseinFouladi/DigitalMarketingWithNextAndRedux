import {
  ...
  Tr,
  HeadTr,
} from "../../styles/payment/CartTable.style";
          ...
          <Tbody>
            {products &&
              products.map((item, index) => {
                return (
                  <Tr key={item.productId} indx={index}>
                    <Td>
                      <StripeCheckoutButton
                        id="stripe"
                        price={item.price * item.reserveCount}
                      />
                    </Td>
                    <Td>
                      <ToggleIcon
                    ...
                    <Td>
                      <ToggleIcon
                        onClick={() => ToggleCount(item, "decrement")}
                        icon={faChevronLeft}
                      />{" "}
                      {item.reserveCount}{" "}
                      <ToggleIcon
                        onClick={() => ToggleCount(item, "increment")}
                        icon={faChevronRight}
                      />
                    </Td>
