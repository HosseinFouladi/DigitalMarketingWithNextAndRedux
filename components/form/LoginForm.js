  ...
  return (
    <Form type={type} onSubmit={handleSubmit(submitForm)}>
          ...
          {errors.name && (
            <ErrorSpan>
              {errors.name.type === "requird"
                ...
                : "نام وارد شده حداقل باید سه حرف داشته باشد !"}
            </ErrorSpan>
          )}
      ...
      <InputBox>
        ...
        {errors.username && (
          <ErrorSpan>
            {errors.username.type === "requird"
              ? "نام کاربری خود را وارد کنید!"
              : "نام کاربری وارد شده حداقل باید سه حرف داشته باشد!"}
          </ErrorSpan>
        )}
      ...
      <InputBox>
        ...
        {errors.password && (
          <ErrorSpan>
            {errors.password.type === "requird"
              ? "رمز عبور خود را وارد کنید!"
              : "رمزعبور وارد شده حداقل باید پنج حرف داشته باشد!"}
          </ErrorSpan>
        )}
      ...
      <SubmitButton
        types={"edit"}
        disabled={userLoading && type != "login" ? true : false}
        loading={userLoading && type != "login"}
        name="edit"
      >
        <ButtonContent>
          {(!userLoading || type == "login") && (
            <ButtonText>{type === "login" ? "ورود" : "ثبت نام"}</ButtonText>
          )}
          {userLoading && type != "login" && (
