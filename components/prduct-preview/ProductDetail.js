...
import { selectCurrentCategory, selectCurrentProduct, selectLikeSituation } from "../../redux/selectors/ProductSelector";
import { ColorsType, ColorsTypeBox, Details, DetailsBox, ColorsText,LikeBox, LikeCount, LikeIcon, ProductName, PropertiyList, Property, TitleBox } from "../../styles/product-preview/ProductDetail.style";
        ...
        <Details>
            ...
            <DetailsBox>
                <LikeBox>
                    ...
                    <LikeIcon onClick={handleColor} color={isLike==true?colors.red:colors.like} icon={faHeart}  ></LikeIcon>
                </LikeBox>
                <LikeBox>
                ...
                <PropertiyList >
                    <Property>دسته بندی کالا: {category && category.categoryName}</Property>
